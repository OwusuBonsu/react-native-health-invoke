...
declare module 'react-native-health' {
  ...
  export interface AppleHealthKit {
    ...
    //New Stuff
    //hearing
    getEnvironmentalAudioExposureEvent(
      options: HealthInputOptions,
      callback: (err: string, results: HealthValue) => void,
    ): void
    getHeadphoneAudioExposureEvent(
      options: HealthInputOptions,
      callback: (err: string, results: HealthValue) => void,
    ): void

    //falls
    getNumberOfTimesFallen(
      options: HealthInputOptions,
      callback: (err: string, results: HealthValue) => void,
    ): void

    //vitals
    getLowCardioFitnessEvent(
      options: HealthInputOptions,
      callback: (err: string, results: HealthValue) => void,
    ): void
    getLowHeartRateEvent(
      options: HealthInputOptions,
      callback: (err: string, results: HealthValue) => void,
    ): void
    getIrregularHeartRateEvent(
      options: HealthInputOptions,
      callback: (err: string, results: HealthValue) => void,
    ): void
    getAppleWalkingSteadiness(
      options: HealthInputOptions,
      callback: (err: string, results: HealthValue) => void,
    ): void
    getAppleWalkingSteadinessEvent(
      options: HealthInputOptions,
      callback: (err: string, results: HealthValue) => void,
    ): void
    ...
    getWalkingDoubleSupportPercentage(
      options: HealthInputOptions,
      callback: (err: string, results: HealthValue) => void,
    ): void
    getStairAscentSpeed(
    ...
    getStairDescentSpeed(
      options: HealthInputOptions,
      callback: (err: string, results: HealthValue) => void,
    ): void
    
    getHighHeartRateEvent(
      options: HealthInputOptions,
      callback: (err: string, results: HealthValue) => void,
    ): void
