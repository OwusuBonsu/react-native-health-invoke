...
- (nullable HKObjectType *)getReadPermFromText:(nonnull NSString*)key {
    ...
    if (@available(iOS 13.0, *)) {
        ...
        }else if ([@"HeadphoneAudioExposureEvent" isEqualToString:key]) { //new
            return [HKObjectType categoryTypeForIdentifier:HKCategoryTypeIdentifierHeadphoneAudioExposureEvent];
        }else if ([@"EnvironmentalAudioExposureEvent" isEqualToString:key]) { //new
    ...
    //vitals
    else if  ([@"LowCardioFitnessEvent" isEqualToString: key]) {
    ...
    }else if ([@"IrregularHeartRateEvent" isEqualToString: key]) {
        return [HKObjectType categoryTypeForIdentifier:HKCategoryTypeIdentifierIrregularHeartRhythmEvent];
    }else if ([@"AppleWalkingSteadiness" isEqualToString: key]) {
