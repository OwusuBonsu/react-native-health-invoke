...
//all new stuff-------------------------------
//hearing
RCT_EXPORT_METHOD(getEnvironmentalAudioExposureEvent:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
{
    [self _initializeHealthStore];
    [self vitals_getEnvironmentalAudioExposureEvent:input callback:callback];
}
RCT_EXPORT_METHOD(getHeadphoneAudioExposureEvent:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
{
    [self _initializeHealthStore];
    [self vitals_getHeadphoneAudioExposureEvent:input callback:callback];
}

//falls
RCT_EXPORT_METHOD(getNumberOfTimesFallen:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
{
    [self _initializeHealthStore];
    [self vitals_getNumberOfTimesFallen:input callback:callback];
}

//vitals
RCT_EXPORT_METHOD(getLowCardioFitnessEvent:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
{
    [self _initializeHealthStore];
    [self vitals_getLowCardioFitnessEvent:input callback:callback];
}

RCT_EXPORT_METHOD(getLowHeartRateEvent:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
{
    [self _initializeHealthStore];
    [self vitals_getLowHeartRateEvent:input callback:callback];
}

RCT_EXPORT_METHOD(getHighHeartRateEvent:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
{
    [self _initializeHealthStore];
    [self vitals_getHighHeartRateEvent:input callback:callback];
}

RCT_EXPORT_METHOD(getIrregularHeartRateEvent:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
{
    [self _initializeHealthStore];
    [self vitals_getIrregularHeartRateEvent:input callback:callback];
}
